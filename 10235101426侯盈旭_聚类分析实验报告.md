...
```60:79:code/hierarchical_clustering.py
...
```61:115:code/spectral_clustering.py
...
```49:101:code/kmeans_clustering.py
    model = KMeans(
        n_clusters=n_clusters,
        init=init,
        n_init=n_init,
...
```51:109:code/dbscan_clustering.py
    model = DBSCAN(
        eps=eps,
...
```60:122:code/hierarchical_clustering.py
    model = AgglomerativeClustering(
        n_clusters=n_clusters,
        linkage=linkage,
        compute_full_tree=compute_full_tree,
...
```61:126:code/spectral_clustering.py
    model = SpectralClustering(
        n_clusters=n_clusters,
        affinity=affinity,
        gamma=gamma,
